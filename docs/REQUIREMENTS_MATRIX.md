...
| R9 | New-context recommendation | Tokyo history improves ranking after Hakone arrival and contextual actions | public requests, catalog, candidates, impressions, interactions; protected utility | Recall/NDCG/MRR, regret, calibration, adaptation delay | Partial/executable. T3.4 controls, the frozen-embedding ranker, and frozen seen/unseen region/POI plus observable early/late transfer slices are executable. A hash-matched immutable T3.5 comparison has been archived for one small synthetic fixed-seed lineage. Exposure-counterfactual evaluation, utility regret, and probability recovery remain pending; the evaluator-only T3.7 artifact explicitly marks regret unavailable. Observed interactions do not establish personalization or causal utility. |
